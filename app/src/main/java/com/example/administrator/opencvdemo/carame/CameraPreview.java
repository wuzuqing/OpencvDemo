...
public class CameraPreview extends TextureView {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new com.example.administrator.opencvdemo.carame.ImageSaver(reader.acquireNextImage(), Integer.valueOf(mCameraId), new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsolutePath() + "/temp.jpg"),mOnCallBack,cropRect));
        }
    };
