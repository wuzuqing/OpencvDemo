...
public interface Constant {
    ...
    String YA_MEN_MEN_KE = "YA_MEN_MEN_KE";
    String YA_MEN_ZHUN_ZOU = "YA_MEN_ZHUN_ZOU";
    String YA_MEN_LIN_SHI = "YA_MEN_LIN_SHI";
    String YA_MEN_LIN_SHI_CLOSE = "YA_MEN_LIN_SHI_CLOSE";
    String YA_MEN_CHOOSE_YING = "YA_MEN_CHOOSE_YING";
